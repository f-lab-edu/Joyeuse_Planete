...
public class FoodOrderRelease {
  ...
  public static FoodOrderRelease from(Long foodId, Long orderId) {
    return FoodOrderRelease.builder().foodId(foodId).orderId(orderId).build();
  }
}
